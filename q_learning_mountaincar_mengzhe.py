...
class FeatureTransformer:
  def __init__(self, env, n_components=500):
    ...
    # this shows how to tranform observation to a feature representation
...
# this is similar to DQN
# need to see the video: why it needs to use partial_fit to a target 0 and why this is 
# the same as optiminsitic initial value
class Model:
